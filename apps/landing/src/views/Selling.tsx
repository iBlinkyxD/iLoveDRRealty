    ...
    <div className="bg-paper">
      ...
      <div className="bg-ink py-17.5 px-7">
        <div className="max-w-310 mx-auto">
          <div className="text-center max-w-160 mx-auto mb-12.5">
      ...
      <div className="bg-ink py-17.5 px-7">
        <div className="max-w-200 mx-auto text-center">
          ...
          <p className="font-serif text-2xl font-medium italic text-white leading-normal mt-4.5">
      ...
      {/* ── Final CTA ── */}
      <div className="bg-brand py-15 px-7">
