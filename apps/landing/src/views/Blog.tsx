...
export default function Blog() {
  ...
  return (
    <div className="bg-paper">
      ...
      {/* ── Hero ── */}
      <div className="relative overflow-hidden bg-ink min-h-130">
        ...
        <div className="absolute top-0 right-0 w-[42%] h-full opacity-[.28] grid grid-cols-2 grid-rows-2 gap-1.5 p-3">
        ...
        <div className="relative max-w-310 mx-auto pt-17.5 px-7 pb-15">
          <div className="max-w-180">
            ...
            <h1 className="font-serif text-[clamp(34px,5.5vw,60px)] font-bold text-white mt-5 mb-4 tracking-[-.02em] leading-[1.02]">
              Your guide to{' '}
            ...
            <p className="text-white/78 text-4.25 leading-[1.65] max-w-145 font-sans">
            ...
            {/* Stats strip */}
            <div className="flex flex-wrap gap-9 mt-9.5">
              {STATS.map(([n, l], i) => (
                <div key={i}>
      ...
      {/* ── Featured article ── */}
      <div className="bg-paper pt-15 px-7 pb-7.5">
        <div className="max-w-310 mx-auto">
          <div className="text-2.75 font-bold tracking-[.22em] uppercase text-coral font-sans">★ Featured this week</div>
          <h2 className="font-serif text-7 font-semibold text-ink mt-2 mb-6.5">
            Where to start your Dominican journey
          </h2>
          <div className="relative rounded-3xl overflow-hidden cursor-pointer grid min-h-95 shadow-[0_30px_80px_-30px_rgba(0,16,46,.35)]"
            style={{ gridTemplateColumns: '1.1fr 1fr' }}>
            {/* Image placeholder */}
            <div className="relative">
              <div className="h-full min-h-95" style={{ backgroundImage: `url(${FEATURED.img})`, backgroundSize: 'cover', backgroundPosition: 'center' }} />
              <div className="absolute inset-0"
            ...
            {/* Content */}
            <div className="pt-12 px-11 pb-12 flex flex-col justify-center text-white"
              style={{ background: 'linear-gradient(135deg, #00102e 0%, #1a3a6e 100%)' }}>
              <h3 className="font-serif text-8 font-semibold text-white leading-[1.12] mb-4 tracking-[-.01em]">
                {FEATURED.title}
              </h3>
      ...
      {/* ── Editor's picks ── */}
      <div className="max-w-310 mx-auto pt-5 px-7 pb-12.5">
        <div className="grid grid-cols-2 gap-5.5">
          {EDITOR_PICKS.map((p, i) => {
            const info = catInfo(p.cat)
            return (
              <div key={i} onClick={() => go('blog')}
                className="relative rounded-2xl overflow-hidden cursor-pointer bg-paper border border-line-soft shadow-[0_12px_30px_-20px_rgba(0,16,46,.15)]"
      ...
      {/* ── Category navigator ── */}
      <div className="bg-paper2 py-15 px-7">
        <div className="max-w-310 mx-auto">
            ...
            {CATS.map(({ key, label, icon, a, b }) => {
              ...
              return (
                <button
                  ...
                  className={`rounded-2xl py-5 px-3.5 cursor-pointer font-sans flex flex-col items-center gap-2 transition-all duration-200 ${active ? '-translate-y-0.5' : ''}`}
                  style={{
                ...
                >
                  <span className="text-7">{icon}</span>
                  <span className="text-[12.5px] font-bold text-center leading-[1.2]">{label}</span>
                </button>
              )
            })}
          </div>
      ...
      {/* ── Guides grid ── */}
      <div className="max-w-310 mx-auto py-15 px-7">
        <div className="flex justify-between items-end mb-6.5 flex-wrap gap-3">
          <div>
            ...
            <h2 className="font-serif text-7 font-semibold text-ink mt-2">{shownGuides.length} guides</h2>
          </div>
      ...
      <div className="text-white py-17.5 px-7 relative overflow-hidden"
        ...
        <div className="max-w-310 mx-auto relative">
          ...
          <h2 className="font-serif text-8 font-semibold text-white mt-2.5 mb-2">
          ...
          <div className="relative grid grid-cols-6 gap-3.5">
            {/* Connecting line */}
            <div className="absolute top-10 left-[8%] right-[8%] h-0.5"
            ...
            {STEPS.map(([n, icon, title, desc], i) => (
              <div key={i} onClick={() => go('blog')} className="relative cursor-pointer">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full grid place-items-center text-8 border-0.75 border-white/15 relative z-2"
      ...
      {/* ── FAQ ── */}
      <div className="bg-paper py-17.5 px-7">
        <div className="max-w-230 mx-auto">
          <div className="text-center mb-9">
            ...
            <h2 className="font-serif text-8 font-semibold text-ink mt-2.5 mb-2">
              ...
              return (
                <div key={i} className="bg-paper rounded-xl overflow-hidden transition-[border-color] duration-200"
                  ...
                  <button
                    ...
                    className="w-full flex justify-between items-center gap-3 py-4.5 px-5.5 bg-transparent border-none cursor-pointer text-left font-sans text-[15.5px] font-semibold text-ink"
                  >
                  ...
                  {open && (
                    <div className="pt-0 pr-5.5 pb-5 pl-16 text-sm text-ink2 leading-[1.65] font-sans">
                      {a}
                    </div>
                  )}
                </div>
      ...
      {/* ── Newsletter CTA ── */}
      <div className="py-17.5 px-7 relative overflow-hidden"
        ...
        <div className="relative max-w-230 mx-auto text-center">
          ...
          <h2 className="font-serif text-9 font-semibold text-white mt-4.5 mb-3 leading-[1.1] tracking-[-.01em]">
          ...
          <div className="flex gap-2.5 max-w-120 mx-auto bg-white/18 p-1.5 rounded-full backdrop-blur-2.5 border border-white/30">
            <input
              ...
              className="flex-1 py-3.25 px-4.5 rounded-full border-none font-sans text-sm bg-transparent text-white outline-none"
            />
            <button className="bg-white text-coral-deep border-none py-2.75 px-5.5 rounded-full font-sans text-[13.5px] font-bold cursor-pointer">
              Subscribe free
            </button>
          </div>
