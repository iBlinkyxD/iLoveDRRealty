...
function SnapshotColumn({ data, changedKeys, isProposed }: ColProps) {
  ...
  const propFields: PF[] = ([
    ...
    { Icon: BedDouble,        label: t('edit_review.label_bedrooms'),    key: 'bedrooms',        value: num('bedrooms') || null },
    { Icon: Bath,             label: t('edit_review.label_bathrooms'),   key: 'bathrooms',       value: num('bathrooms') || null },
    ...
    { Icon: TrendingUp,       label: t('edit_review.label_roi'),         key: 'roi',             value: num('roi') || null },
